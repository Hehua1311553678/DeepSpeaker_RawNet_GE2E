...
import constants_vctk as c#=================================================================================================2020/04/02 22:59
from constants_vctk import SAMPLE_RATE#=================================================================================================2020/04/02 22:59
...
def data_catalog(dataset_dir=c.DATASET_DIR, pattern='*.npy'):
    ...
    # libri['speaker_id'] = libri['filename'].apply(lambda x: x.split('/')[-2])#=======================================================================2020/04/02 23:02
    libri['speaker_id'] = libri['filename'].apply(lambda x: x.split('/')[-1].split('_')[0])#=======================================================================2020/04/17 20:41
...
def prep(libri,out_dir=c.DATASET_DIR,name='0'):
    ...
    for i in range(len(libri)):
        ...
        target_filename = out_dir + filename.split("/")[-1].split('.')[0] + '.npy'#================================================================2020/04/02 23:02
        print("target_filename:{}".format(target_filename))#=========================================================2020/04/17 21:15
...
if __name__ == '__main__':
    ...
    # preprocess_and_save("F:/hehua/DB/VCTK/VCTK-Corpus/wav48")#==============================================================2020/04/02 23:00
    #===================================================2020/04/17 21:19
    if not os.path.exists(c.DATASET_DIR):
        os.makedirs(c.DATASET_DIR)
    # ===================================================
    preprocess_and_save("E:/DB/VCTK/VCTK-Corpus/wav48")#==============================================================2020/04/17 20:37