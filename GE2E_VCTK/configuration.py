...
data_arg.add_argument('--tdsv', type=str2bool, default=True, help="text dependent or not")#========================================================2020/03/21 12:03
...
model_arg.add_argument('--model_path', type=str, default='./vctk_tdsv_iter245_epoch10_spk90_N4_M5_model', help="model directory to save or load")#==============================2020/05/20 16:26
model_arg.add_argument('--model_num', type=int, default=244, help="number of ckpt file to load")#==============================2020/05/20 16:26
# model_arg.add_argument('--model_num', type=int, default=6, help="number of ckpt file to load")#==============================2020/05/20 16:26

# Training Parameters
train_arg = parser.add_argument_group('Training')
train_arg.add_argument('--spk_num', type=int, default=90, help="number of speakers of epoch")#==============================2020/05/22 13:17
train_arg.add_argument('--train', type=str2bool, default=False, help="train session or not(test session)")#==============================2020/05/20 16:26
# train_arg.add_argument('--train', type=str2bool, default=True, help="train session or not(test session)")#==============================2020/05/20 16:26
train_arg.add_argument('--N', type=int, default=4, help="number of speakers of batch")
train_arg.add_argument('--M', type=int, default=5, help="number of utterances per speaker")#==============================2020/05/20 16:26
# train_arg.add_argument('--M', type=int, default=5, help="number of utterances per speaker")#==============================2020/05/20 16:26
...
train_arg.add_argument('--iteration', type=int, default=245, help="max iteration")#==============================2020/05/20 16:26
# train_arg.add_argument('--iteration', type=int, default=100000, help="max iteration")#==============================2020/05/20 16:26
