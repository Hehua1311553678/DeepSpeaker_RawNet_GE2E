...
# audio_paths= [r'F:\hehua\DB\Aishell1\aishell-1\train',r'F:\hehua\DB\Aishell1\aishell-1\dev',r'F:\hehua\DB\Aishell1\aishell-1\test']
#               # utterance dataset
# audio_paths= [r'D:\DB\Aishell1\aishell-1\train',r'D:\DB\Aishell1\aishell-1\dev',r'D:\DB\Aishell1\aishell-1\test']
audio_paths= [r'G:\hehua\DB\VCTK\VCTK-Corpus\wav48']
              # utterance dataset========================================================2020/04/10 9:58
# clean_path = r'F:\hehua\DB\VCTK+noise\clean_testset_wav'  # clean dataset
# noisy_path = r'F:\hehua\DB\VCTK+noise\noisy_testset_wav'  # noisy dataset
